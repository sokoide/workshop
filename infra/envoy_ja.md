...
> **💡 用語集**: この実習で登場する[サイドカーパターン](glossary_ja.md#architecture)や[L7 トラフィック制御](glossary_ja.md#network)などの専門用語は [用語集](glossary_ja.md) を参照してください。
...
クリーンアーキテクチャにおける「Framework & Drivers」層（詳細）として Envoy を捉えることができます。
