...
- [ ] ハッシュベースとレンジベースのどちらが「範囲検索」に適しているか説明できる
- [ ] 「ホットシャード」が発生するメカニズムを説明できる
- [ ] 自身のプロジェクトに最適なシャーディング戦略を 1 つ挙げられる
...
- [ ] 「Fan-out」が増大することによるシステムへの弊害を 3 つ挙げられる
- [ ] クエリの局所性を高めるためのシャードキー選定のコツを説明できる
- [ ] インデックスの再構築なしで Fan-out を抑える方法を 1 つ挙げられる
...
- [ ] Elasticsearch の「Primary Shard」の役割を説明できる
- [ ] Cortex の「Ingester」がどのようにデータの整合性を保っているか概要を理解した
- [ ] リング型の一貫性ハッシュのメリットを説明できる
