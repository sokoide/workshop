...
const file_greeter_proto_rawDesc = "" +
	...
	"\aGreeter\x12,\n" +
	"\bSayHello\x12\x10.pb.HelloRequest\x1a\x0e.pb.HelloReply\x124\n" +
	"\x0eSayHelloStream\x12\x10.pb.HelloRequest\x1a\x0e.pb.HelloReply0\x01\x12,\n" +
	"\x04Chat\x12\x10.pb.HelloRequest\x1a\x0e.pb.HelloReply(\x010\x01BBZ@github.com/sokoide/workshop/infra/assets/http_persistent_conn/pbb\x06proto3"
...
var file_greeter_proto_depIdxs = []int32{
	...
	0, // 1: pb.Greeter.SayHelloStream:input_type -> pb.HelloRequest
	0, // 2: pb.Greeter.Chat:input_type -> pb.HelloRequest
	1, // 3: pb.Greeter.SayHello:output_type -> pb.HelloReply
	1, // 4: pb.Greeter.SayHelloStream:output_type -> pb.HelloReply
	1, // 5: pb.Greeter.Chat:output_type -> pb.HelloReply
